        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <c:choose>
                ...
                <c:when test="${role == 'ADMIN'}">
                    ...
                    <div class="mb-6">
                        <h2 class="text-lg font-semibold text-slate-800 mb-4">Visit Status Overview</h2>
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div class="bg-amber-50 rounded-lg border border-amber-200 p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-xl font-semibold text-amber-700">${visitsRegistered}</p>
                                        <p class="text-xs text-amber-600">Waiting for Vitals</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-indigo-50 rounded-lg border border-indigo-200 p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-xl font-semibold text-indigo-700">${visitsVitalsRecorded}</p>
                                        <p class="text-xs text-indigo-600">Waiting for Diagnosis</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-cyan-50 rounded-lg border border-cyan-200 p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-xl font-semibold text-cyan-700">${visitsDiagnosisRecorded}</p>
                                        <p class="text-xs text-cyan-600">Waiting for Medication</p>
                                    </div>
                                </div>
                            </div>
                        </div>
