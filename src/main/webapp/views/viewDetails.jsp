...
<head>
    ...
    <style>
        /* Left accent bar helper classes */
    ...
    <main class="p-8 max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Full clinical record for visit #${visitDetails.visitId}</p>
            </div>
            <!-- Status Badge -->
            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border
                <c:choose>
                    <c:when test="${visitDetails.visitStatus == 'REGISTERED'}">bg-blue-100 text-blue-700 border-blue-500</c:when>
                    <c:when test="${visitDetails.visitStatus == 'VITALS_RECORDED'}">bg-amber-100 text-amber-700 border-amber-500</c:when>
                    <c:when test="${visitDetails.visitStatus == 'DIAGNOSED'}">bg-indigo-100 text-indigo-700 border-indigo-500</c:when>
                    <c:when test="${visitDetails.visitStatus == 'COMPLETED'}">bg-green-100 text-green-700 border-green-500</c:when>
                    <c:otherwise>bg-red-100 text-red-700 border-red-500</c:otherwise>
                </c:choose>
            ">
        ...
        <div class="space-y-6">
            ...
            <!-- Visit Info Card -->
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 card-accent-blue hover:shadow-md transition duration-200">
                ...
                <dl class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <dd class="text-sm font-medium text-slate-800">#${visitDetails.visitId}</dd>
                    </div>
                    <div>
                        <dt class="text-xs font-medium text-slate-500 uppercase tracking-wide mb-1">Status</dt>
                        <dd class="text-sm text-slate-800">${visitDetails.visitStatus}</dd>
                    </div>
                    <div>
            ...
            <!-- Patient Info Card -->
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 card-accent-slate hover:shadow-md transition duration-200">
                <div class="flex items-center gap-2 mb-4">
            ...
            <!-- Vitals Card -->
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 card-accent-amber hover:shadow-md transition duration-200">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <div>
                        ...
                        <dd class="text-sm text-slate-800">
                            <c:choose>
                                ...
                                <c:otherwise><span class="text-slate-400 italic">Not recorded</span></c:otherwise>
                            </c:choose>
                        </dd>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <dd class="text-sm text-slate-800">
                            <c:choose>
                                ...
                                <c:otherwise><span class="text-slate-400 italic">N/A</span></c:otherwise>
                            </c:choose>
                        </dd>
                    </div>
                </dl>
            ...
            <!-- Diagnosis Card -->
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 card-accent-indigo hover:shadow-md transition duration-200">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <div>
                        ...
                        <dd class="text-sm text-slate-800">
                            <c:choose>
                                ...
                                <c:otherwise><span class="text-slate-400 italic">Not assigned</span></c:otherwise>
                            </c:choose>
                        </dd>
                    </div>
                    <div>
                        <dt class="text-xs font-medium text-slate-500 uppercase tracking-wide mb-1">Clinical Notes</dt>
                        <dd class="text-sm text-slate-800 leading-relaxed bg-slate-50 rounded-lg p-3 border border-slate-100">
                            <c:choose>
            ...
            <!-- Pharmacy Card -->
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 card-accent-green hover:shadow-md transition duration-200">
                <div class="flex items-center gap-2 mb-4">
